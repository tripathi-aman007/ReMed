    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.donate:
                ...
                Intent intent1 = new Intent(FirstPage.this, Donate.class);
                startActivity(intent1);
                break;
            case R.id.button2:
                Toast.makeText(this, "Buy Fresh!", Toast.LENGTH_SHORT).show();
                Intent intent2 = new Intent(FirstPage.this, FreshBuy.class);
                startActivity(intent2);
                break;
            case R.id.button3:
                Toast.makeText(this, "Re Buy!", Toast.LENGTH_SHORT).show();
                Intent intent3 = new Intent(FirstPage.this, ReBuy.class);
                startActivity(intent3);
                break;
            case R.id.button:
//                Toast.makeText(this, "Buy Fresh!", Toast.LENGTH_SHORT).show();
                Intent data = new Intent(FirstPage.this, Register.class);
                startActivity(data);
                break;
        }
    }
